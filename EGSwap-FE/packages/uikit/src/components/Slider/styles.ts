...
import bunny from "./svg/egswap_logo_svg.svg";
...
const getBaseThumbStyles = ({ isMax, disabled }: StyledInputProps) => `
  ...
  background-image: url('/images/home/new/egswap.png');
...
export const BunnyButt = styled.div<DisabledProp>`
  background: url("/images/home/new/egswap.png") no-repeat;
  background-size: 30px 30px;
  z-index: 1;
  height: 32px;
...
export const BarBackground = styled.div<DisabledProp>`
  background-color: ${({ theme, disabled }) => theme.colors[disabled ? "textDisabled" : "textDisabled"]};
  height: 8px;
  position: absolute;
  top: 18px;
  width: 95%;
