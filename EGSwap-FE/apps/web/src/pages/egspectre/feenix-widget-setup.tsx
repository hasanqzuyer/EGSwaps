...
const Feenix: React.FC<React.PropsWithChildren> = () => {
  const iframeCode = `<iframe class="egspectre-widget" src="${window.location.origin}/egspectre/feenix-widget" frameborder="0" />`
    ...
    <Page>
      ...
      <div className="flex w-full flex-col px-[10%]">
        ...
        <span className="text-gray-700">
          Follow the instructions bellow to install and activate the Feenix widget on your website.
        </span>
        <div
...
Feenix.displayName = 'egspectre'

export default Feenix
