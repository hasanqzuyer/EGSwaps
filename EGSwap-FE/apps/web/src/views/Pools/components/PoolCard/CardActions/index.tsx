  ...
  return (
    <Flex flexDirection="column">
      <Flex flexDirection="column">
        <>
          <Box display="inline">
            <InlineText color="pool.textSubtle" bold fontSize="12px">
              {`${earningToken.symbol} `}
            </InlineText>
            <InlineText color="pool.textSubtle" textTransform="uppercase" bold fontSize="12px">
              {t('Earned')}
            </InlineText>
          </Box>
          <HarvestActions
        ...
        <Box display="inline">
          <InlineText color={isStaked ? 'pool.textSubtle' : 'pool.textSubtle'} textTransform="uppercase" bold fontSize="12px">
