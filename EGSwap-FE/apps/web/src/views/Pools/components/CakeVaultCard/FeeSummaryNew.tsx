...
const FeeSummaryNew: React.FC<React.PropsWithChildren<FeeSummaryProps>> = ({
  stakingTokenSymbol,
  stakeAmount,
  vaultKey,
}) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      ...
      <Text>
        {t(
          'Only applies within 72 days of staking. Unstaking after 72 days will not include a fee. Timer resets every time you stake new CAKE in the pool.',
        )}
      </Text>
    </>,
    { placement: 'top-start' },
  ...
  return (
    <>
      <Flex mt="24px" alignItems="center" justifyContent="space-between">
        ...
        <Text fontSize="14px">{/* {'0.1%'} {stakingTokenSymbol} */}</Text>
      </Flex>
