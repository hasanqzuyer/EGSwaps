    ...
    <TransactionErrorContent
      message={
        <>
          ...
          <LinkExternal
            href="https://docs.egswap.exchange/help/troubleshooting-errors#this-transaction-will-not-succeed-either-due-to-price-movement-or-fee-on-transfer.-try-increasing-yo"
...
interface ConfirmSwapModalProps {
  trade?: Trade<Currency, Currency, TradeType> | StableTrade | KyberSwapClass<Currency, Currency, TradeType>
  originalTrade?: Trade<Currency, Currency, TradeType> | StableTrade | KyberSwapClass<Currency, Currency, TradeType>
