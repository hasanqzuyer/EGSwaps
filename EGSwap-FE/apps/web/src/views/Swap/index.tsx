...
export default function Swap() {
  ...
  return (
    <Page removePadding={isChartExpanded} hideFooterOnDesktop={isChartExpanded} >
      <Flex width={['328px', '100%']} justifyContent="center" position="relative" alignItems="flex-start" marginBottom={50}>
        ...
        <Flex flexDirection="column" paddingTop={router.pathname.includes("embed-swap") ? 0 : 75}>
