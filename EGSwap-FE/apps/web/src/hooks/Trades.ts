...
export function useAllCommonPairs(currencyA?: Currency, currencyB?: Currency, externalSwap: boolean = false): Pair[] {
  ...
  const allPairs = usePairs(allPairCombinations, externalSwap)
...
export function useTradeExactIn(
  ...
  externalSwap: boolean = false,
): Trade<Currency, Currency, TradeType> | null {

  const allowedPairs = useAllCommonPairs(currencyAmountIn?.currency, currencyOut, externalSwap)
  ...
  return useMemo(() => {
    ...
    return null
  }, [allowedPairs, currencyAmountIn, currencyOut, singleHopOnly, externalSwap])
}
...
export function useTradeExactOut(
  ...
  const allowedPairs = useAllCommonPairs(currencyIn, currencyAmountOut?.currency, externalSwap)
  ...
  return useMemo(() => {
    ...
    return null
  }, [currencyIn, currencyAmountOut, allowedPairs, singleHopOnly, externalSwap])
}
