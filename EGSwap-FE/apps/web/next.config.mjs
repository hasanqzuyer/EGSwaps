...
const config = {
  ...
  async rewrites() {
    return [
      ...
      {
        source: '/bapi/:rest*',
        destination: 'https://www.apollox.finance/bapi/:rest*',
      },
      {
        source: '/fapi/:rest*',
        destination: 'https://www.apollox.finance/fapi/:rest*',
      },
      {
        source: '/cloud-futures/:rest*',
        destination: 'https://static.apollox.com/cloud-futures/:rest*',
      }
    ]
  },
  async headers() {
